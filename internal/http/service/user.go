...
func NewUserService(logger *xlog.Logger, userRepo repository.UserRepository) *userService {
	return &userService{
		logger:   logger,
		userRepo: userRepo,
	}
...
func (s *userService) Delete(ctx context.Context, id string) error {
	return s.userRepo.Deletes([]*model.User{
...
func (s *userService) List(ctx context.Context, listDto *dto.UserList) ([]*model.User, int64, error) {
	return s.userRepo.List(listDto)
}
